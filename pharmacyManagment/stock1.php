  ...
  font-size: 20px;
	...
	{	
		...
		echo "<table >";
			...
			<th>Amount</th><th>supplier registered NO</th><th> supplied medicine</th>
			</tr>";
			while($row = $result ->fetch_assoc())
			{
				
		        $id =$row["stockNO"]; 
				Echo "<tr> <td>" .$row['stockNO']."</td> <td> " .$row['stockAmount']."</td><td>" .$row['regNum']."</td><td>" .$row['Medicine_name']."</td></tr>";
				echo "<br/>";
		}
		echo "</table>";
	}		
