  ...
  margin-left:5%;
	...
	{	
		...
		echo "</table>";
			...
			<th>email</th><th>message</th><th> Delete </th>
			</tr>";
			while($row = $result ->fetch_assoc())
			{
				
		        $id =$row["messageNo"]; 
				Echo "<tr> <td>" .$row['name']."</td> <td> " .$row['email']."</td><td>" .$row['description']."</td><td><button id = 'delete'><a href ='deletemessage.php?id=$id'>delete</a></button></td></tr>";
				echo "<br/>";
		}
		echo "</table>";
	}		
